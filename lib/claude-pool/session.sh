...
_dispatch_to_slot() {
  ...
  # INVARIANT: clear the done sentinel AFTER claiming the slot. Clearing
  # before the lock would delete the sentinel for whichever job currently
  # owns the slot, breaking its wait_for_done.
